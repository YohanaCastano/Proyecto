...
echo "<a href='Editar.php?id=" . $row['NombreProveedor'] . "' class='edit-button'>Editar</a> | ";
echo "<a href='eliminar.php?id=" . $row['NombreProveedor'] . "' class='delete-button'>Eliminar</a>";
